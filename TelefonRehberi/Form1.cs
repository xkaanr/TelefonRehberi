...
namespace TelefonRehberi
{
    public partial class Form1 : Form
    {
        ...
        {
            string sqlBaglantiCumlesi = "server=.;Database=TelefonRehberi;password=1234;user=sa;";
        ...
        private void dataGridViewNumaralar_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
